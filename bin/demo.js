...
Demo.render = function(svg) {
	...
	arc.style.set_stroke(sxg_Paint.Color(thx_color__$Hsla_Hsla_$Impl_$.toRgbxa(thx_color__$Hsla_Hsla_$Impl_$.create(90,0.5,0.7,1))));
};
...
sxg_Element.prototype = {
	...
	,setData: function(key,value) {
		this.doc.setAttribute(this.el,"data-" + key,value);
	}
	,getData: function(key) {
		return this.doc.getAttribute(this.el,"data-" + key);
	}
	,toString: function() {
	...
	,get_className: function() {
		return this.doc.getAttribute(this.el,"class");
	}
	,set_className: function(v) {
		return this.doc.setAttribute(this.el,"class",v);
	}
...
sxg_Paint.Url = function(url) { var $x = ["Url",2,url]; $x.__enum__ = sxg_Paint; $x.toString = $estr; return $x; };
...
sxg_Paints.apply = function(paint,doc,el,attribute,useAlpha) {
	if(useAlpha == null) useAlpha = true;
	var alpha = "" + attribute + "-opacity";
	switch(paint[1]) {
	case 0:
...
var sxg_Style = function(doc,el) {
	this.doc = doc;
	this.el = el;
};
sxg_Style.__name__ = ["sxg","Style"];
sxg_Style.prototype = {
	el: null
	,doc: null
	,strokeWidth: null
	...
	,set_fill: function(v) {
		sxg_Paints.apply(v,this.doc,this.el,"fill",true);
		return v;
	}
	,get_stroke: function() {
...
sxg_core_DomDocument.__name__ = ["sxg","core","DomDocument"];
...
sxg_core_XmlDocument.prototype = {
	...
	,p: function(ns) {
		var pr = sxg_core_XmlDocument.prefixes.get(ns);
